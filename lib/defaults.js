...
const DEFAULT_CONFIG = {
  ...
  // Opt-in realism passes. Off by default so a fresh install behaves exactly as
  // before; each is a targeted post-translation correction.
  realism: {
    ...
    // pipeline.js. For users who haven't run the external AGI/COD tool.
    agilityCodSizePenalty: false,
  },
};
