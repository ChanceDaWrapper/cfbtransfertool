...
const DEFAULT_CONFIG = {
  ...
  // 'legacy': today's extraction logic, unchanged. 'exit': the Season Exit
  // Population constructor (lib/rosetta/population.js) -- fixes the
  // Transfer_*-inclusion bug and the dead 'Invalid' filter in the legacy
  // path. Not yet exposed in the UI; default stays 'legacy' until validated.
  population: {
    mode: 'legacy', // 'legacy' | 'exit'
  },
  // Rosetta migration feature flag. 'v1': today's rating-conversion logic,
  // unchanged, reached through the Translator seam (lib/rosetta/translation/)
  // rather than called directly. 'rosetta': the real translation engine --
  // currently just delegates to 'v1' too (no translation math exists yet),
  // so this flag is a no-op either way until a later phase. Not yet exposed
  // in the UI; default stays 'v1'.
  translation: {
    strategy: 'v1', // 'v1' | 'rosetta'
  },
  general: {
...
const DESCRIPTIONS = {
  ...
  'translation.strategy': 'Engineering flag: which rating-conversion engine runs. "v1" is today\'s logic. "rosetta" is the Rosetta translation engine -- currently identical to v1 (no translation math built yet).',
