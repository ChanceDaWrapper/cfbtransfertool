...
const DEFAULT_CONFIG = {
  ...
  draftValue: {
    positionValueWeight: 1,     // multiplier on the Position Value table above
    awardsWeight: 0.5,          // multiplier on career award points (Heisman, All-American, etc.)
    athleticismWeight: 2,       // multiplier on the measurables (height/weight/speed/...) bonus
    roundWeight: 1,             // how much CFB's own projected round still matters
  },
  devTraits: {
...
const DESCRIPTIONS = {
  ...
  'draftValue.athleticismWeight': 'How much elite measurables (height, weight, speed, and position-relevant physical tools) push a player up the draft order, independent of their overall -- an "athletic freak" with average production still tests well enough to intrigue a real team.',
  'draftValue.roundWeight': 'How much CFB\'s own projected round still factors into where a player lands, alongside overall, awards, athleticism, and position value.',
};
