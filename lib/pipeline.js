...
async function extractLeavingPlayers(cfbSavePath, log = () => {}, opts = {}) {
  ...
  rows.source = source;
  rows.populationMode = populationMode;
  rows.regime = regime; // 'A' | 'B' | null (legacy mode doesn't have a Rosetta regime)
