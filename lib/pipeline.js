...
const RANK_BUST_GEM_HIGH_PCHANCE = 0.52; // best pick in the tier (rankFrac 0)
const RANK_BUST_GEM_LOW_PCHANCE = 0.08;  // worst pick in the tier (rankFrac 1) -- never zero
